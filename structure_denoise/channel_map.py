...
_ratv4_intan = dict(
    geometry = (8, 8),
    pitch = 0.42,
    rows = [2, GND, 0, 6, 4, 2, 1, 4, 3, 5, 2, 6, 0, 7, 4, 6, 5, 1, 3, 3, 1, 7, 4,
            5, 0, 5, 2, 7, 3, 6, 1, GND, 2, 6, 0, 7, 4, 5, 1, 5, 3, 7, 2, 3, 0, 1,
            4, 6, 5, 6, 3, 7, 1, 6, 4, 5, 0, 4, 2, 2, 3, 0, 1, GND],
    cols = [3, GND, 3, 3, 3, 0, 2, 0, 2, 2, 1, 2, 1, 2, 1, 1, 3, 0, 1, 0, 1, 3, 2,
            1, 2, 0, 2, 1, 3, 0, 3, GND, 4, 7, 4, 6, 4, 7, 5, 6, 5, 4, 6, 7, 6, 7,
            6, 4, 4, 6, 6, 5, 6, 5, 5, 5, 5, 7, 5, 7, 4, 7, 4, GND]
)


map_specs = {'psv_244_intan': _psv_244_intan,
             'ratv4_intan': _ratv4_intan}
